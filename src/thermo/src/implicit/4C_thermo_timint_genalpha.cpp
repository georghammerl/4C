      ...
      fcapn_(nullptr)
{
  ...
  // mid-temperatures
  tempm_ = std::make_shared<Core::LinAlg::Vector<double>>(*discret_->dof_row_map(), true);
  // mid-temperature rates
  ratem_ = std::make_shared<Core::LinAlg::Vector<double>>(*discret_->dof_row_map(), true);
  ...
  fintm_ = std::make_shared<Core::LinAlg::Vector<double>>(*discret_->dof_row_map(), true);
  ...
  fcapm_ = std::make_shared<Core::LinAlg::Vector<double>>(*discret_->dof_row_map(), true);
  ...
  fextm_ = std::make_shared<Core::LinAlg::Vector<double>>(*discret_->dof_row_map(), true);
