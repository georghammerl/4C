...
namespace Cut
{
  ...
  class Options
  {
   public:
    ...
    Cut::NodalDofSetStrategy get_nodal_dof_set_strategy() { return nodal_dofset_strategy_; }
   ...
   private:
    /** \brief Float_type for geometric intersection computation */
    Cut::CutFloatType geomintersect_floattype_;

    /** \brief Float_type for geometric distance computation */
    Cut::CutFloatType geomdistance_floattype_;

    /** \brief Float_type used in Cut::POSITION for compute_distance*/
    Cut::CutFloatType general_position_dist_floattype_;

    /** \brief Float_type used in Cut::POSITION for ComputePosition*/
    Cut::CutFloatType general_position_pos_floattype_;
    ...
    Cut::NodalDofSetStrategy nodal_dofset_strategy_;
