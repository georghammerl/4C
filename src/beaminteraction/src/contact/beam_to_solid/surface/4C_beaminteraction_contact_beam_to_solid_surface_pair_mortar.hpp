...
#ifndef FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_SURFACE_PAIR_MORTAR_HPP
#define FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_SURFACE_PAIR_MORTAR_HPP
