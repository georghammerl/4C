...
#ifndef FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_VISUALIZATION_OUTPUT_WRITER_UTILS_HPP
#define FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_VISUALIZATION_OUTPUT_WRITER_UTILS_HPP
