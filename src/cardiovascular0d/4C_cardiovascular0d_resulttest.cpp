    ...
    const Core::IO::InputParameterContainer& container, int& nerr, int& test_count)
{
  ...
  if (havecardio_syspulcirculation_)
  {
    ...
    if (quantity == "p_at_l")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 0)];
    }
    ...
    if (quantity == "q_vin_l")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 1)];
    }
    ...
    if (quantity == "q_vout_l")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 2)];
    }
    ...
    if (quantity == "p_v_l")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 3)];
    }
    ...
    if (quantity == "p_ar_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 4)];
    }
    ...
    if (quantity == "q_ar_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 5)];
    }
    ...
    if (quantity == "p_ven_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 6)];
    }
    ...
    if (quantity == "q_ven_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 7)];
    }
    ...
    if (quantity == "p_at_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 8)];
    }
    ...
    if (quantity == "q_vin_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 9)];
    }
    ...
    if (quantity == "q_vout_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 10)];
    }
    ...
    if (quantity == "p_v_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 11)];
    }
    ...
    if (quantity == "p_ar_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 12)];
    }
    ...
    if (quantity == "q_ar_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 13)];
    }
    ...
    if (quantity == "p_ven_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 14)];
    }
    ...
    if (quantity == "q_ven_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 15)];
    }
  ...
  if (havecardiorespir_syspulperiphcirculation_)
  {
    ...
    if (quantity == "p_venmsc_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 16)];
    }
    ...
    if (quantity == "q_venmsc_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 17)];
    }
    ...
    if (quantity == "p_vencer_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 18)];
    }
    ...
    if (quantity == "q_vencer_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 19)];
    }
    ...
    if (quantity == "p_vencor_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 20)];
    }
    ...
    if (quantity == "q_vencor_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 21)];
    }
    // test for systemic venous pressure
    if (quantity == "p_ven_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 22)];
    }
    // test for systemic venous flux
    if (quantity == "q_ven_sys")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 23)];
    }
    // test for right atrial pressure
    if (quantity == "p_at_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 24)];
    }
    // test for right ventricular in-flux
    if (quantity == "q_vin_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 25)];
    }
    // test for right ventricular out-flux
    if (quantity == "q_vout_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 26)];
    }
    // test for right ventricular pressure
    if (quantity == "p_v_r")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 27)];
    }
    // test for pulmonary arterial pressure
    if (quantity == "p_ar_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 28)];
    }
    // test for pulmonary arterial flux
    if (quantity == "q_ar_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 29)];
    }
    ...
    if (quantity == "p_cap_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 30)];
    }
    ...
    if (quantity == "q_cap_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 31)];
    }
    // test for pulmonary venous pressure
    if (quantity == "p_ven_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 32)];
    }
    // test for pulmonary venous flux
    if (quantity == "q_ven_pul")
    {
      ...
      if (havegid)
        result = (*cardvasc0d_dof_).local_values_as_span()[cardvasc0dmap.lid(offset + 33)];
    }
